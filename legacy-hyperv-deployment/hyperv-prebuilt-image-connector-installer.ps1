...
$archiveURI = "https://github.com/Twingate-Solutions/twingate-connector-hyperv/releases/download/hyperv-image/Ubuntu_Twingate_Connector-22_04.zip" # URL of the current VM archive
